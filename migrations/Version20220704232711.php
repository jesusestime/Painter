 ...
 */
final class Version20220704232711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paint_category (paint_id INT NOT NULL, category_id INT NOT NULL, INDEX IDX_6ECF4F139017B5FF (paint_id), INDEX IDX_6ECF4F1312469DE2 (category_id), PRIMARY KEY(paint_id, category_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
